...
void object3D::draw(QOpenGLShaderProgram *program, QOpenGLFunctions *functions, bool usingTextures)
{
    ...
    program->setUniformValue("u_materialPropery.ambienceColor", m_material->AmbienceColor());
    program->setUniformValue("u_materialPropery.specularColor", m_material->SpecularColor());
