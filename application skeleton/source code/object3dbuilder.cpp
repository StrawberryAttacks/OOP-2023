...
Object3dBuilder &Object3dBuilder::add_diffuse_map(const QImage &texture)
{
    bind_material();
...
Object3dBuilder &Object3dBuilder::add_normal_map(const QImage &texture)
{
    bind_material();

    mtl->setNormalMap(texture);

    return static_cast<Object3dBuilder&>(*this);
}

Object3dBuilder &Object3dBuilder::add_shinnes(float shinnes)
{
    bind_material();

    mtl->setShinnes(shinnes);
