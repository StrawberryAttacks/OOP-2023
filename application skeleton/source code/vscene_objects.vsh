...
void main(void)
{
    ...
    v_normal = normalize(vec3(mv_matrix * vec4(a_normal, 0.0)));//передаем нормаль, умноженную на МВМ,
                            //чтобы картинка формировалась с учетом сдвига камеры и модификаций поворота объекта
